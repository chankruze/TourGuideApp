    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        place1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent numbersIntent = new Intent(MainActivity.this, ScrollingActivity.class);
        ...
        place2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent familyIntent = new Intent(MainActivity.this, ScrollingActivity.class);
